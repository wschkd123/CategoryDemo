...
public class SecondCategoryAdapter extends BaseAdapter {
    ...
    public SecondCategoryAdapter(Context context, List<CategoryBean.DataBean.DataListBean> foodDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.category_second_item, null);
